...
public class homework_1013
{
    ...
    private static Panel pn1=new Panel(new GridLayout(4,3));//數字+刪除+等於
    private static Panel pn2=new Panel(new GridLayout(4,1));//加減乘除
...
public static void main(String args[])
{
    ...
    lab.setBounds(20,40,280,50);//數字顯示框
    lab.setFont(new Font("Comic Mono", Font.BOLD, 20));
    lab.setBackground(new Color(252,210,210));
    pn1.setBounds(20,100,215,230);
    pn1.setFont(new Font("Comic Mono", Font.BOLD, 18));
    pn2.setBounds(235,100,65,230);  
    pn2.setFont(new Font("Comic Mono", Font.BOLD, 18)); 
    //0~9數字鈕
    for(int i=9;i>=0;i--){
